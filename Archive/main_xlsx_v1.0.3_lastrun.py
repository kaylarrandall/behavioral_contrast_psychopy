...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Michael\\Nextcloud\\code\\behavior_contrast_main_v1.0.3\\main_xlsx_v1.0.3_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials2 = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('bin/.xlsx/main_loop.xlsx'), 
        seed=None, 
    )
    ...
    for thisTrials2 in trials2:
        ...
        for thisTrials_exp_2 in Trials_exp_2:
            ...
            main_square_exp_2 = data.Routine(
                ...
                components=[button, mouse_logging, textbox_routine_1, score_textbox],
            )
            ...
            points_square_exp_2 = data.Routine(
                ...
                components=[button_2, textbox, mouse_logging_2],
            )
